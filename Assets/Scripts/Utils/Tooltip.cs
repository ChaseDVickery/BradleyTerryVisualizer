...
public class Tooltip : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    void Start()
    {
        tooltip = Instantiate(tooltipPrefab, canvas != null ? canvas.transform : gameObject.GetComponentInParent<Canvas>().transform);
    ...
    private void ShowTooltip() {
        ...
        Debug.Log($"mousePos: {mousePos.x}, {mousePos.y}... offset: {offset.x}, {offset.y}");
